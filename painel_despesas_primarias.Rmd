...
if (condicao==1){
  ...
  graph_1<<-
    ...
    theme(
      ...
      panel.background = element_rect(fill = "#000080"), # "#121212"
  ...
  if (input$freeScale){
    ...
    graph_1<<-
      graph_1+ facet_wrap(NO_FUNCAO_PT~.)
  ...
  #ggplot(graph_1, tooltip = c("ano", "despesa", "text"))
